export default {
  settings: {
    ...
    settings: {
      title: "Settings",
      description:
        "Here you can manage general settings for the extension, such as enabling or disabling it, and adjusting other preferences.",
      enableExtension: {
      ...
      general: {
        ...
        uncensorOnFocus: {
          ...
          description:
            "Uncensor inputs when they are focused, allowing you to see the original content.",
        },
      },
      websites: {
    ...
    filters: {
      sensitiveAlert: {
        ...
        description:
          "This section contains all your filters, which may include sensitive content. Click the button below to continue.",
        button: "Continue to Filters",
      },
      title: "Filters",
      description:
        "Manage your filters here. You can add, edit, or remove filters that hide unwanted content.",
      addFilter: {
        title: "Add Filter",
    ...
    about: {
      ...
      description:
        "This extension helps you manage unwanted content on the web by allowing you to filter out specific words or phrases. You can add filters to censor or remove content that you find inappropriate, too sensitive, or simply distracting.",
      usefulLinks: "Useful Links",
      githubRepository: "GitHub Repository",
      officialWebsite: "Official Website",
      reportIssue: "Report an Issue",
      supportProject: "Support the Project",
      footer: "Don't Show {{version}} distributed under the MIT License by Valerio Clemenzi",
    },
  },
  popup: {
