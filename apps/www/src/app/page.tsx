...
export default async function Home() {
  return (
    <main className="bg-primary h-full">
      <div className="container mx-auto flex h-screen items-center justify-center space-x-28">
        <div className="w-1/2 space-y-4">
          ...
          <div className="flex w-1/2 gap-2 pt-4">
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="mx-auto mb-20 grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3">
